...
## Setting up Jekyll pipeline

To set up Jekyll publishing  you will need [Ruby](https://www.ruby-lang.org/en/) language, dependency manager [Bundler](http://bundler.io/) and atomatic page generator [Jekyll](jekyllrb.com) :  
...
## Preparing for publishing
 ...
 Here's I demonstrate how to replicate verbatim the styles and settings from the official website of [rmarkdown](https://github.com/rstudio/rmarkdown/tree/gh-pages).
