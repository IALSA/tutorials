...
Setting up Jekyll publishing requires a serveral preliminary  installations. 
...
### Bundler  
  a. Open local GitHub folder  
  b. Initiate command line by typing <code>cmd</code> in the address bar of the File Explorer  
